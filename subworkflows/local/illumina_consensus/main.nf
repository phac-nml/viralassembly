...
include { BCFTOOLS_CONSENSUS_AMBIGUOUS  } from '../../../modules/local/bcftools/consensus/main'

// Output Final Consensus and Adjust Sequence Header
include { BCFTOOLS_CONSENSUS_FINAL      } from '../../../modules/local/bcftools/consensus/main'
...
workflow WF_ILLUMINA_CONSENSUS {
    ...
    if (params.use_ivar) {
        ...
        //
        ADJUST_FASTA_HEADER(
            BCFTOOLS_CONSENSUS_FINAL.out.consensus,
            ch_reference,
            '.consensus',
            ''
        )
