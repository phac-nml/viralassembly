...
plot_ly(summary_depth_df, x = ~position, text = ~paste0(
  ...
  layout(title = list(text= "Median genomic read depth with deviation", x = 0.5),
    xaxis = list(title = "Genome Position", range = c(0, genome_length), nticks = 10, showgrid = FALSE, gridcolor = "#dadce0", griddash = "dot"),
...
### **Table 1.** Software Versions {data-height=550}
