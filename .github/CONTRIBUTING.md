...
9. Update the `assets/rmarkdown-reports/reportDashboard.Rmd` file with the appropriate outputs, if applicable. For sample level outputs, update the `assets/rmarkdown-reports/sampleSubpage.Rmd` file, if applicable.
10. Add a description of the output files and if relevant any appropriate images from the HTML reports to `docs/output.md`.
